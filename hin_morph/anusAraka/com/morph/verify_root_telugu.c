...
void
verify_root(guessed_root,pdgm,cat,offset,ans_table,ans_ar,j,DBM_FLAG,db_lex)
...
/* 582 : koVn   
764 to 798 both inclusive: auxiliary verbs                          
These numbers are 1 less than the corresponding line numbers 
from feature_value file
*/                                                                    
if((offset != 582) && ( offset <= 763 || offset >= 799))  
match1 = match_in_dict(guessed_root,pdgm,cat,offset,ans_table,ans_ar,j);
if(!match1)
{
if((offset <= 763) && ( offset != 582)) { strcpy(cat,"verb");}
else if(offset > 798) { strcpy(cat,"noun");}
