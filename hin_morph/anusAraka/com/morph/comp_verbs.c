...
{
get_derived_rt(root,aux_info_ar->suffix,sizeof_aux,sizeof(aux_info_ar[0]),strcmp,DBM_FLAG,db_lex,"verb",ans_root,aux_verbs);
if(strcmp(ans_root,"")) 
{
if(!strcmp(aux_verbs,tmp_aux_verbs))
{
if(strcmp(aux_verb,""))
{
strcat(aux_verbs,"_");
