...
int offset,ptr,i,pos,j,no_of_entries,cum_no_of_entries;
...
j=0;
      ...
      {
/*
       fprintf(fp3,"%-35s,%-14s,%-8d,",suff,add,ptr);
*/
...
ptr = ftell(fp2);
cum_no_of_entries = cum_no_of_entries + no_of_entries;
ptr = ptr + cum_no_of_entries;
/*
fprintf(fp3,"%-4d\n",no_of_entries);
*/
fprintf(fp3,"%d\n",no_of_entries);
