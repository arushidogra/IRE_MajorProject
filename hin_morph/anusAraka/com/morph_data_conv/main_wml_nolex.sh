...
perl /home/arushi/Desktop/MajorProject/temp_pr/IRE_MajorProject/hin_morph/anusAraka/wamil/morph/test/rename_tams.pl < feature_value > j
mv j feature_value
cat feature_value nf_mapfile >jnk
mv jnk feature_value
sed '/NonFinVerbs/d' offset > jnk
cat jnk nf_offset > jnk1
mv jnk1 offset
rm jnk
