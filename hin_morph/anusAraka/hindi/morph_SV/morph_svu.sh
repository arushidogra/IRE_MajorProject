...
/home/arushi/Desktop/MajorProject/temp_pr/IRE_MajorProject/hin_morph/anusAraka/hindi/morph/test/mohu.sh < wrds > wrds.mo
paste -d, wrds wrds.mo | grep ',.' > tmp.mo
sed '1,$s/^w[0-9]* //' < uword > unkn
perl /home/arushi/Desktop/MajorProject/temp_pr/IRE_MajorProject/hin_morph/anusAraka/hindi/morph_SV/spell_variation.pl NO_DBG U< unkn > unkn.mo
...
rm wrds wrds.mo tmp.mo mo2 story_wrds unkn unkn.mo uword
if test -a tmp
then
	rm tmp
fi
